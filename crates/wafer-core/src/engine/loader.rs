...
/// Default epoch deadline (ticks before interruption): 1 second at 10ms ticks.
...
/// Configured wasmtime Engine with fuel metering and epoch interruption.
...
impl WaferEngine {
    ...
    pub fn linker(&self) -> Result<&Linker<WaferState>> {
        ...
        // OnceLock::set race is fine -- either writer's linker is valid
